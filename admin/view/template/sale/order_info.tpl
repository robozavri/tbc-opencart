...
<div id="content">
  ...
  <h3 class="panel-title">TBC bank payment method condition
        </div>
        <div class="panel-body">
            <p><b>STATUS :</b> <?php echo $t_status; ?></p>
            <p><b>TOTAL :</b> <?php echo $t_total; ?></p>
            <p><b>CURRENCY :</b> <?php echo $t_currency; ?></p>
            <p><b>CUSTOMER ID :</b> <?php echo $t_customer_id; ?></p>
            <p><b>TRANSACTION ID :</b> <?php echo $t_transaction_id; ?></p>
            <p>
              <form onsubmit="return confirm('Do you really want to reverse transaction ?');" action="<?php echo $t_reverse_transaction_url;?>" method="post">
                <input type="hidden" name="trans_id" value="<?php echo $t_transaction_id; ?>">
                <input type="hidden" name="amount" value="<?php echo $t_total; ?>">
                <input type="hidden" name="order_id" value="<?php echo $t_order_id; ?>">
              <input type="submit" class="btn btn-primary" value="Reverse transaction">
            </form>
              </p>
                <p>
            <form onsubmit="return confirm('Do you really want to Refaund transaction amount ?');" action="<?php echo $t_return_transaction_amount_url;?>" method="post">
                <input type="hidden" name="trans_id" value="<?php echo $t_transaction_id; ?>">
                <input type="hidden" name="amount" value="<?php echo $t_total; ?>">
                <input type="hidden" name="order_id" value="<?php echo $t_order_id; ?>">
              <input type="submit" class="btn btn-primary" value="Refaund transaction amount">
            </form>
          </p>
        </div>
      </div>
