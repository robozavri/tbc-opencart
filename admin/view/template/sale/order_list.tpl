              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'order_status') { ?>
                    <a  onclick="return false" href="<?php echo $sort_status; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_status; ?></a>
                    <?php } else { ?>
                    <a  onclick="return false" href="<?php echo $sort_status; ?>"><?php echo $column_status; ?></a>
                    <?php } ?></td>
